...
<body>
  ...
  <main class="settings-container">
    <div class="settings-card">
      ...
      <jou_gegevens class="content">
        <div class="row"><span>Naam</span>
          <a href="Inloggen.php">verander</a>
        </div>
        <div class="row"><span>wachtwoord</span>
          <a href="Inloggen.php">verander</a>
        </div>
        <div class="row"><span>email</span>
          <a href="Inloggen.php">verander</a>
        </div>
        <div class="row"><span>telephone number</span>
          <a href="Inloggen.php">verander</a>
        </div>
      </jou_gegevens>
    </div>
